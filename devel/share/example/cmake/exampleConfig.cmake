...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /home/zcl/test/src/example)
  set(example_DEVEL_PREFIX /home/zcl/test/devel)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /home/zcl/test/install)
...
if(NOT "/home/zcl/test/devel/include " STREQUAL " ")
  set(example_INCLUDE_DIRS "")
  set(_include_dirs "/home/zcl/test/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'zcl <zcl@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zcl/test/src/example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zcl/test/devel/lib;/opt/ros/melodic/lib)
